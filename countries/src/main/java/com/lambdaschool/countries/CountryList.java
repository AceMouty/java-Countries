...
public class CountryList {
    ...
    private ArrayList<Country> filter(ArrayList<Country> list, CheckCountry cb){
    ...
    public ArrayList<Country> sortedNames(){
        ArrayList<Country> newList = new ArrayList<Country>(countryList);
        newList.sort((n1, n2) -> n1.getName().compareToIgnoreCase(n2.getName()));
        return  newList;
    }

    public ArrayList<Country> sortedNames(ArrayList<Country> list){
